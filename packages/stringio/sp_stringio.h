...
sp_int sp_StringIO_puts(sp_StringIO *s, const char *str);
sp_int sp_StringIO_puts_empty(sp_StringIO *s);
sp_int sp_StringIO_print(sp_StringIO *s, const char *str);
...
sp_int sp_StringIO_print_v1(sp_StringIO *s, sp_RbVal a);
sp_int sp_StringIO_print_v2(sp_StringIO *s, sp_RbVal a, sp_RbVal b);
sp_int sp_StringIO_print_v3(sp_StringIO *s, sp_RbVal a, sp_RbVal b, sp_RbVal c2);
sp_int sp_StringIO_puts_v1(sp_StringIO *s, sp_RbVal a);
sp_int sp_StringIO_puts_v2(sp_StringIO *s, sp_RbVal a, sp_RbVal b);
sp_int sp_StringIO_puts_v3(sp_StringIO *s, sp_RbVal a, sp_RbVal b, sp_RbVal c2);
