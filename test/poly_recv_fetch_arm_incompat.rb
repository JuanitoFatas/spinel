...
# call passes a String key — the String can't be cast to sp_int sym,
...
# into a sp_int slot — fails C compile.
...
# (sp_int) in isolation. The dispatch site below mustn't widen it.
def warmup
  f = FlashLike.new
  f.fetch(:a, "1")
  f.fetch(:b, "2")
