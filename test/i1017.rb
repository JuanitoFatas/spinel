...
# wasn't cast to (sp_int)(uintptr_t) before being returned through the
# proc-fn `sp_int` ABI slot. The existing #709 cast bridge (in
...
# `sp_int`-returning `_sp_proc_fn_N`. With the fix, the read yields
